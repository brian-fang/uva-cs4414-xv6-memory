...
int main(int argc, char *argv[])
{
  ...
  10:	83 ec 0c             	sub    $0xc,%esp
    ...
    if ( 0 /*argc > 1 */) {
        ...
        pid = getpid();
  13:	e8 3a 03 00 00       	call   352 <getpid>
  ...
  1b:	89 c6                	mov    %eax,%esi
        sbrk(5000000);
  1d:	68 40 4b 4c 00       	push   $0x4c4b40
  22:	e8 33 03 00 00       	call   35a <sbrk>
        ...
        */
        ...
        int parent = fork();
  27:	e8 9e 02 00 00       	call   2ca <fork>
  2c:	89 c3                	mov    %eax,%ebx


        char* buf = malloc(2>>5);
  2e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  35:	e8 76 06 00 00       	call   6b0 <malloc>


        if(parent) {
  3a:	83 c4 10             	add    $0x10,%esp
  3d:	85 db                	test   %ebx,%ebx
  3f:	74 1e                	je     5f <main+0x5f>
            *buf = 5;
  41:	c6 00 05             	movb   $0x5,(%eax)
  ...
  4d:	e8 fe 03 00 00       	call   450 <printf>
            wait();
  52:	e8 83 02 00 00       	call   2da <wait>
  ...
  64:	52                   	push   %edx
  65:	50                   	push   %eax
  66:	68 bb 07 00 00       	push   $0x7bb
  6b:	6a 01                	push   $0x1
  6d:	e8 de 03 00 00       	call   450 <printf>
  72:	83 c4 10             	add    $0x10,%esp
  75:	eb e3                	jmp    5a <main+0x5a>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
...
printf(int fd, char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb d0 07 00 00       	mov    $0x7d0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 84 0a 00 00       	mov    0xa84,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 84 0a 00 00    	mov    0xa84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 777:	0a 00 00 
 77a:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 88 0a 00 00       	mov    $0xa88,%eax
 789:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 790:	00 00 00 
