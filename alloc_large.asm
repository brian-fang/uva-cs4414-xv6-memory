...
_alloc_large:     file format elf32-i386
...
int main() {
    ...
    test_allocation_no_fork(900 * 1024 * 1024, "900MB", "4MB", 899 * 1024 * 1024, 1 * 1024 * 1024, 450 * 1024 * 1024, 1 * 1024 * 1024, 0);
      16:	6a 00                	push   $0x0
      18:	68 00 00 10 00       	push   $0x100000
      1d:	68 00 00 20 1c       	push   $0x1c200000
      22:	68 00 00 10 00       	push   $0x100000
      27:	68 00 00 30 38       	push   $0x38300000
      2c:	68 0a 23 00 00       	push   $0x230a
      31:	68 0e 23 00 00       	push   $0x230e
      36:	68 00 00 40 38       	push   $0x38400000
...
void test_out_of_bounds_internal() {
    ...
    (void) end_of_heap[out_of_bounds_offset];
      6d:	03 05 88 31 00 00    	add    0x3188,%eax
}
...
int test_out_of_bounds_fork(int offset, const char *crash_message, const char *no_crash_message) {
    ...
    return test_simple_crash(test_out_of_bounds_internal, crash_message, no_crash_message);
     ...
     1ad:	5d                   	pop    %ebp
    out_of_bounds_offset = offset;
     1ae:	a3 88 31 00 00       	mov    %eax,0x3188
    return test_simple_crash(test_out_of_bounds_internal, crash_message, no_crash_message);
...
void test_out_of_bounds_no_fork(int offset, const char *no_crash_message) {
    ...
    out_of_bounds_offset = offset;
     ...
     1c9:	a3 88 31 00 00       	mov    %eax,0x3188
    test_func();
...
int test_allocation_fork(int size, const char *describe_size, const char *describe_amount, int offset1, int count1, int offset2, int count2) {
    ...
    printf(1, "testing allocating %s and reading/writing to %s segments of it\n", describe_size, describe_amount);
     4ff:	57                   	push   %edi
     500:	56                   	push   %esi
     501:	68 14 23 00 00       	push   $0x2314
     506:	6a 01                	push   $0x1
    ...
    if (pid == 0) {
     ...
     5ce:	31 db                	xor    %ebx,%ebx
                printf(1, FAIL_MSG "unknown error using %s parts of %s allocation\n", describe_amount, describe_size);
     5d0:	68 3c 24 00 00       	push   $0x243c
     5d5:	6a 01                	push   $0x1
     ...
     5eb:	31 db                	xor    %ebx,%ebx
        printf(1, FAIL_MSG "allocation test: first fork failed\n");
     5ed:	68 00 25 00 00       	push   $0x2500
     5f2:	6a 01                	push   $0x1
     ...
     610:	57                   	push   %edi
     611:	56                   	push   %esi
     612:	68 78 24 00 00       	push   $0x2478
     617:	6a 01                	push   $0x1
     ...
     632:	bb 01 00 00 00       	mov    $0x1,%ebx
            printf(1, PASS_MSG "allocating %s and using %s parts of allocation passed\n", describe_size, describe_amount );
     637:	68 bc 24 00 00       	push   $0x24bc
     63c:	6a 01                	push   $0x1
     ...
     653:	31 db                	xor    %ebx,%ebx
                printf(1, FAIL_MSG "allocation initialized to non-zero value\n");
     655:	68 98 23 00 00       	push   $0x2398
     65a:	6a 01                	push   $0x1
     ...
     673:	31 db                	xor    %ebx,%ebx
                printf(1, FAIL_MSG "allocating (but not using) %s with sbrk() returned error\n", describe_size);
     675:	56                   	push   %esi
     676:	68 54 23 00 00       	push   $0x2354
     67b:	6a 01                	push   $0x1
     ...
     693:	31 db                	xor    %ebx,%ebx
                printf(1, FAIL_MSG "wrong size allocated by %s allocation\n", describe_size);
     695:	56                   	push   %esi
     696:	68 08 24 00 00       	push   $0x2408
     69b:	6a 01                	push   $0x1
     ...
     6ac:	31 db                	xor    %ebx,%ebx
                printf(1, FAIL_MSG "using %s parts of %s allocation read wrong value\n", describe_amount, describe_size);
     6ae:	68 cc 23 00 00       	push   $0x23cc
     6b3:	6a 01                	push   $0x1
...
void test_copy_on_write_main_child(int result_fd, int size, const char *describe_size, int forks) {
  ...
  if (failed) {
    ...
    printf(2, "unsupported number of children in test_copy_on_write\n");
     ...
     9cb:	68 30 25 00 00       	push   $0x2530
     9d0:	6a 02                	push   $0x2
  ...
  for (char *p = old_end_of_heap; p < new_end_of_heap; ++p) {
     ...
     a79:	51                   	push   %ecx
     a7a:	68 68 25 00 00       	push   $0x2568
     a7f:	6a 01                	push   $0x1
...
void test_copy_on_write_main_child_alt(int result_fd, int size, const char *describe_size, int forks, int early_term) {
  ...
  if (failed) {
    ...
    printf(2, "unsupported number of children in test_copy_on_write\n");
     ...
     cfb:	68 30 25 00 00       	push   $0x2530
     d00:	6a 02                	push   $0x2
...
int test_copy_on_write_less_forks(int size, const char *describe_size, int forks) {
  ...
  if (text[0] == 'X') {
    ...
    case 'p':
     ...
     f90:	68 08 26 00 00       	push   $0x2608
     f95:	6a 01                	push   $0x1
    ...
    printf(1, PASS_MSG "copy on write test passed --- allocate %s; "
     fa8:	56                   	push   %esi
     fa9:	53                   	push   %ebx
     faa:	68 14 27 00 00       	push   $0x2714
     faf:	6a 01                	push   $0x1
    ...
    return 1;
     ...
     fcb:	68 d0 25 00 00       	push   $0x25d0
     fd0:	6a 01                	push   $0x1
    ...
    printf(1, FAIL_MSG "copy on write test failed --- crash?\n");
     ...
     fe3:	68 a0 25 00 00       	push   $0x25a0
     fe8:	6a 01                	push   $0x1
    ...
    1007:	68 54 26 00 00       	push   $0x2654
    100c:	6a 01                	push   $0x1
    ...
    1023:	68 90 26 00 00       	push   $0x2690
    1028:	6a 01                	push   $0x1
    ...
    1043:	68 dc 26 00 00       	push   $0x26dc
    1048:	6a 01                	push   $0x1
...
int test_copy_on_write_less_forks_alt(int size, const char *describe_size, int forks, int early_term) {
  ...
  if (text[0] == 'X') {
    ...
    10e2:	68 dc 26 00 00       	push   $0x26dc
    10e7:	6a 01                	push   $0x1
    ...
    1100:	56                   	push   %esi
    1101:	53                   	push   %ebx
    1102:	68 14 27 00 00       	push   $0x2714
    1107:	6a 01                	push   $0x1
    ...
    1123:	68 90 26 00 00       	push   $0x2690
    1128:	6a 01                	push   $0x1
    ...
    1143:	68 a0 25 00 00       	push   $0x25a0
    1148:	6a 01                	push   $0x1
    ...
    1163:	68 08 26 00 00       	push   $0x2608
    1168:	6a 01                	push   $0x1
    ...
    1183:	68 d0 25 00 00       	push   $0x25d0
    1188:	6a 01                	push   $0x1
...
int _test_copy_on_write(int size,  const char *describe_size, int forks, int use_alt, int early_term, int pre_alloc, const char* describe_prealloc) {
  ...
  return 0;
    ...
    120c:	68 84 27 00 00       	push   $0x2784
    1211:	6a 01                	push   $0x1
    ...
    12a6:	68 dc 26 00 00       	push   $0x26dc
    12ab:	6a 01                	push   $0x1
    ...
    12c3:	68 00 28 00 00       	push   $0x2800
    12c8:	6a 01                	push   $0x1
    ...
    12e6:	68 28 28 00 00       	push   $0x2828
    12eb:	6a 01                	push   $0x1
    ...
    1303:	68 d0 27 00 00       	push   $0x27d0
    1308:	6a 01                	push   $0x1
    ...
    1323:	68 a0 25 00 00       	push   $0x25a0
    1328:	6a 01                	push   $0x1
    ...
    1343:	68 d0 25 00 00       	push   $0x25d0
    1348:	6a 01                	push   $0x1
    ...
    1363:	68 90 26 00 00       	push   $0x2690
    1368:	6a 01                	push   $0x1
    ...
    1383:	68 08 26 00 00       	push   $0x2608
    1388:	6a 01                	push   $0x1
...
int test_read_into_alloc_no_fork(int size, int offset, int read_count, char *describe_size, char *describe_offset) {
    ...
    1482:	53                   	push   %ebx
    1483:	68 64 28 00 00       	push   $0x2864
    1488:	6a 01                	push   $0x1
    ...
    15e7:	68 d8 28 00 00       	push   $0x28d8
    15ec:	6a 01                	push   $0x1
    ...
    1603:	68 ac 28 00 00       	push   $0x28ac
    1608:	6a 01                	push   $0x1
...
int test_read_into_cow_less_forks(int size, int offset, int read_count, char *describe_size, char *describe_offset) {
    ...
    17a2:	57                   	push   %edi
    17a3:	68 0c 29 00 00       	push   $0x290c
    17a8:	6a 01                	push   $0x1
    ...
    18b4:	5a                   	pop    %edx
    18b5:	59                   	pop    %ecx
    18b6:	68 a0 29 00 00       	push   $0x29a0
    18bb:	6a 01                	push   $0x1
    ...
    18fb:	68 e0 29 00 00       	push   $0x29e0
    1900:	6a 01                	push   $0x1
    ...
    1914:	68 18 2a 00 00       	push   $0x2a18
    1919:	6a 01                	push   $0x1
    ...
    19c4:	50                   	push   %eax
    19c5:	50                   	push   %eax
    19c6:	68 ac 28 00 00       	push   $0x28ac
            printf(1, FAIL_MSG "wrong value written to memory by read()\n");
    19cb:	6a 01                	push   $0x1
    ...
    1a28:	50                   	push   %eax
    1a29:	50                   	push   %eax
    1a2a:	68 d8 28 00 00       	push   $0x28d8
    ...
    1a31:	57                   	push   %edi
    1a32:	57                   	push   %edi
    1a33:	68 64 29 00 00       	push   $0x2964
    1a38:	6a 01                	push   $0x1
    ...
    1e39:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    1e67:	f7 f1                	div    %ecx
    1e69:	0f b6 92 6c 2a 00 00 	movzbl 0x2a6c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    2084:	e9 8f fe ff ff       	jmp    1f18 <printf+0x48>
          s = "(null)";
    2089:	bb 64 2a 00 00       	mov    $0x2a64,%ebx
        while(*s != 0){
