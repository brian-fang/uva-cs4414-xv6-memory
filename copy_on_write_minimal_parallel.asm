...
_copy_on_write_minimal_parallel:     file format elf32-i386
...
int main(void) {
    ...
    test_copy_on_write_less_forks_alt(4096, "4096", 5, 0);
      16:	6a 00                	push   $0x0
      18:	6a 05                	push   $0x5
      1a:	68 ea 22 00 00       	push   $0x22ea
      1f:	68 00 10 00 00       	push   $0x1000
      24:	e8 17 10 00 00       	call   1040 <test_copy_on_write_less_forks_alt>
    shutdown();
      29:	e8 ac 1d 00 00       	call   1dda <shutdown>
}
